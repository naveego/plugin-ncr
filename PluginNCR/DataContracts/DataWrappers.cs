...
namespace PluginNCR.DataContracts
{
    ...
    {
        [JsonProperty("fromReceivedDateTimeUtc", NullValueHandling = NullValueHandling.Ignore)]
        public DateWrapper FromDateWrapper { get; set; }

        [JsonProperty("toReceivedDateTimeUtc", NullValueHandling = NullValueHandling.Ignore)]
        public DateWrapper ToDateWrapper { get; set; }
    }
